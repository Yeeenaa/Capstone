            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 5:
                  ...
                  _this.addDataToDOM(response.data.posts);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "4990" + '/');
