...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"register1.js":[function(require,module,exports) {
"use strict";
...
var Register1 = /*#__PURE__*/function () {
  function Register1() {
    _classCallCheck(this, Register1);
    ...
    value: function events() {
      ...
      this.button.addEventListener('click', function (e) {
        ...
        _axios.default.post("".concat(_main.backend, "/api/auth/register"), {
          ...
          school: _this.school.value,
          schoolCode: _this.schoolCode.value,
          schoolClass: _this.schoolClass.value
...
var Register2 = /*#__PURE__*/function () {
  function Register2() {
    _classCallCheck(this, Register2);
  ...
  _createClass(Register2, [{
    ...
    value: function events() {
      ...
      this.button.addEventListener('click', function (e) {
        ...
        form.append('name', _this.name.value);
        form.append('email', _this.email.value);
        form.append('password', _this.password.value);
        form.append('school', _this.school.value);
    ...
    value: function events() {
      ...
      this.buttons.forEach(function (btn) {
        btn.addEventListener('click', function (e) {
          ...
          var _btn$value$split = btn.value.split(',AA,');

          var _btn$value$split2 = _slicedToArray(_btn$value$split, 2);
  ...
  _createClass(CreatePost, [{
    ...
    value: function events() {
      ...
      this.button.addEventListener('click', function (e) {
        ...
        var _this$button$value$sp = _this.button.value.split(',AA,'),
            _this$button$value$sp2 = _slicedToArray(_this$button$value$sp, 2),
        ...
        if (['apply', 'pledge'].includes(category)) {
          ...
          form.append('content', _this.content.value);

          if (_this.file.files.length !== 0) {
            _toConsumableArray(_this.file.files).forEach(function (f, i) {
              if (f.type.split('/')[0] === 'image') {
                form.append('images', _this.file.files[i]);
              } else {
                alert('이미지만 첨부 가능합니다.');
                error = true;
                return window.location.replace("/".concat(category, "/create"));
              }
            });
          }

          if (!error) {
            _axios.default.post("".concat(_main.backend, "/api/").concat(category), form, {
              headers: {
                Authorization: "Bearer ".concat(token),
                'Content-Type': 'multipart/form-data'
              }
              ...
              console.log(error); // window.location.replace(`/${category}/create`);
            });
          }
        } else {
          ...
          _form.append('category', category);

          if (_this.file.files.length !== 0) {
            _toConsumableArray(_this.file.files).forEach(function (f, i) {
              if (f.type.split('/')[0] === 'image') {
                _form.append('images', _this.file.files[i]);
              } else if (f.type.split('/')[0] === 'video') {
                _form.append('video', _this.file.files[i]);
              } else {
...
},{"axios":"../node_modules/axios/index.js","./main":"main.js"}],"loadPosts.js":[function(require,module,exports) {
"use strict";
...
var LoadPosts = /*#__PURE__*/function () {
  function LoadPosts() {
    ...
    this.searchTerm = document.querySelector('#write-wrap > input[type=text]');
    this.button = document.querySelector('#searchButton');
    this.form = document.querySelector('#searchForm');
    this.container = document.querySelector('#wrapper > form > table > tbody:nth-child(2)');
  ...
  _createClass(LoadPosts, [{
    ...
    value: function events() {
      ...
      this.form.addEventListener('submit', /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
          var _this$button$value$sp, _this$button$value$sp2, category, token, response;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _this.currentPage = 1;
                  e.preventDefault();
                  _this$button$value$sp = _this.button.value.split(',AA,'), _this$button$value$sp2 = _slicedToArray(_this$button$value$sp, 2), category = _this$button$value$sp2[0], token = _this$button$value$sp2[1];
                  _context.next = 5;
                  return _axios.default.get("".concat(_main.backend, "/api/post"), {
                    headers: {
                      Authorization: "Bearer ".concat(token)
                    },
                    params: {
                      ...
                      category: category,
                      searchParam: _this.searchParam.value,
                      searchTerm: _this.searchTerm.value
                    }
                  });
                ...
                case 5:
                  ...
                  _this.addDataToDOM(response.data.posts, category);
      ...
      window.addEventListener('scroll', /*#__PURE__*/function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
          var _document$documentEle, scrollTop, scrollHeight, clientHeight, _this$button$value$sp3, _this$button$value$sp4, category, token, response;

          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  _document$documentEle = document.documentElement, scrollTop = _document$documentEle.scrollTop, scrollHeight = _document$documentEle.scrollHeight, clientHeight = _document$documentEle.clientHeight;
                  _this$button$value$sp3 = _this.button.value.split(',AA,'), _this$button$value$sp4 = _slicedToArray(_this$button$value$sp3, 2), category = _this$button$value$sp4[0], token = _this$button$value$sp4[1];
                  ...
                  _this.loading.classList.add('show');
    ...
    key: "addDataToDOM",
    value: function addDataToDOM(posts, category) {
      var _this2 = this;

      posts.forEach(function (post) {
        var postElement = document.createElement('tr');
        postElement.innerHTML = "\n            <td width=\"100\" text-align=\"center\">\n               ".concat(post.school, "\n            </td>\n            <td width=\"300\" text-align=\"center\">\n               <a href=\"/").concat(category, "/").concat(post.id, "\" style=\"color: black\">\n               ").concat(post.title, "\n               </a>\n            </td>\n            <td width=\" 300\" text-align=\"center\">\n               ").concat(post.user.name, "\n            </td>\n            <td width=\"100\" text-align=\"center\">\n               ").concat(post.createdAt, "\n            </td>\n            <td width=\"100\" text-align=\"center\">\n               ").concat(post.commentCount, "\uAC1C\n            </td>\n            <td width=\"100\" text-align=\"center\">\n               ").concat(post.viewCount, "\n            </td>\n            ");

        _this2.container.appendChild(postElement);
      });
    }
  }]);
...
},{"axios":"../node_modules/axios/index.js","./main":"main.js"}],"viewPost.js":[function(require,module,exports) {
"use strict";
...
var viewPost = /*#__PURE__*/function () {
  function viewPost() {
    ...
    this.subCommentDeleteBtn = document.querySelectorAll('.subComment-delBtn');
    this.postDeleteBtn = document.querySelector('.post-delBtn');
    this.token = document.querySelector('#commentButton').value.split(',AA,')[1];
    this.events();
  }
  ...
  _createClass(viewPost, [{
    ...
    value: function events() {
      ...
      this.commentForm.addEventListener('submit', /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
          var postId;
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _axios.default.post("".concat(_main.backend, "/api/post/").concat(postId), {
      ...
      _toConsumableArray(this.subCommentForm).forEach(function (subForm, i) {
        subForm.addEventListener('submit', /*#__PURE__*/function () {
          var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    e.preventDefault();
                    postId = window.location.pathname.split('/')[2];
                    commentId = subForm.name;

                    _axios.default.post("".concat(_main.backend, "/api/post/").concat(postId, "/comment/").concat(commentId), {
                      content: _this.subCommentInput[i].value
                    }, {
                      headers: {
                        Authorization: "Bearer ".concat(_this.token)
                      }
      ...
      _toConsumableArray(this.commentDeleteBtn).forEach(function (btn) {
        btn.addEventListener('click', /*#__PURE__*/function () {
          var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
            var postId, commentId, result;
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    postId = window.location.pathname.split('/')[2];
                    commentId = btn.name;
                    result = confirm('삭제합니까?');

                    if (result) {
                      _axios.default.delete("".concat(_main.backend, "/api/post/").concat(postId, "/comment/").concat(commentId), {
                        headers: {
                          Authorization: "Bearer ".concat(_this.token)
                        }
                      }).then(function (response) {
      ...
      _toConsumableArray(this.subCommentDeleteBtn).forEach(function (btn) {
        btn.addEventListener('click', /*#__PURE__*/function () {
          var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
            var subCommentId, result;
            return regeneratorRuntime.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    e.preventDefault();
                    subCommentId = btn.name;
                    result = confirm('삭제합니까?');

                    if (result) {
                      _axios.default.delete("".concat(_main.backend, "/api/post/subComment/").concat(subCommentId), {
                        headers: {
                          Authorization: "Bearer ".concat(_this.token)
                        }
                      }).then(function (response) {
      ...
      this.postDeleteBtn.addEventListener('click', function (e) {
        e.preventDefault();

        var _window$location$path = window.location.pathname.split('/'),
            _window$location$path2 = _slicedToArray(_window$location$path, 3),
            a = _window$location$path2[0],
            category = _window$location$path2[1],
            postId = _window$location$path2[2];

        var result = confirm('삭제합니까?');

        if (result) {
          _axios.default.delete("".concat(_main.backend, "/api/post/").concat(postId, "/"), {
            headers: {
              Authorization: "Bearer ".concat(_this.token)
            }
          }).then(function (response) {
...
},{"axios":"../node_modules/axios/index.js","./main":"main.js"}],"viewApply.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(ViewApply, [{
    ...
    value: function events() {
      this.permitBtn.addEventListener('click', function (e) {
        ...
        if (result) {
          _axios.default.post("".concat(_main.backend, "/api/apply/").concat(userId), {
            permission: 'true'
          }, {
            headers: {
              Authorization: "Bearer ".concat(token)
...
var viewPledge = /*#__PURE__*/function () {
  function viewPledge() {
    _classCallCheck(this, viewPledge);
  ...
  _createClass(viewPledge, [{
    ...
    value: function events() {
      this.voteBtn.addEventListener('click', function (e) {
        ...
        if (result) {
          _axios.default.put("".concat(_main.backend, "/api/pledge/").concat(candidateId), {}, {
            headers: {
              Authorization: "Bearer ".concat(token)
            }
          }).then(function (response) {
...
exports.default = viewPledge;
},{"axios":"../node_modules/axios/index.js","./main":"main.js"}],"evaluation.js":[function(require,module,exports) {
"use strict";
...
var ViewEvaluation = /*#__PURE__*/function () {
  function ViewEvaluation() {
    _classCallCheck(this, ViewEvaluation);
  ...
  _createClass(ViewEvaluation, [{
    key: "events",
    value: function events() {
      var _this = this;

      this.evalForm.addEventListener('submit', function (e) {
        e.preventDefault();
        var rate;

        _toConsumableArray(_this.ratings).forEach(function (rating) {
          if (rating.checked) {
            rate = rating.value;
          }
        });

        _axios.default.post("".concat(_main.backend, "/api/evaluation/").concat(postId), {
          rating: rate
        }, {
          headers: {
            Authorization: "Bearer ".concat(token)
...
},{"axios":"../node_modules/axios/index.js","./main":"main.js"}],"admin.js":[function(require,module,exports) {
"use strict";
...
var Admin = /*#__PURE__*/function () {
  ...
  _createClass(Admin, [{
    ...
    value: function events() {
      ...
      this.applyOpenBtn.addEventListener('click', function (e) {
        e.preventDefault();

        _this.applyBoradOpen();
      });
      this.voteOpenBtn.addEventListener('click', function (e) {
        e.preventDefault();

        _this.voteOpen();
      });
      this.getResultBtn.addEventListener('click', function (e) {
        e.preventDefault();

        _this.getResult();
      });
      this.voteResetBtn.addEventListener('click', function (e) {
        e.preventDefault();
    ...
    key: "applyBoradOpen",
    value: function applyBoradOpen() {
      _axios.default.put("".concat(_main.backend, "/api/apply"), {}, {
        headers: {
          authorization: "Bearer ".concat(token)
        }
      }).then(function (res) {
        if (res.data.status === 'success') alert("\uAC8C\uC2DC\uD310 \uC0C1\uD0DC: " + res.data.isOpen);
    ...
    key: "voteOpen",
    value: function voteOpen() {
      var result = confirm('투표를 시작 또는 종료?');

      if (result) {
        _axios.default.put("".concat(_main.backend, "/api/pledge/admin"), {}, {
          headers: {
            authorization: "Bearer ".concat(token)
          }
        }).then(function (res) {
          if (res.data.status === 'success') alert("\uD22C\uD45C \uAC00\uB2A5 : " + res.data.canVote);
          location.replace('/admin');
        }).catch(function (e) {
          alert("\uC5D0\uB7EC");
          console.log(e);
    ...
    value: function getResult() {
      ...
      _axios.default.get("".concat(_main.backend, "/api/pledge/admin"), {
        headers: {
          authorization: "Bearer ".concat(token)
        }
      }).then(function (res) {
        if (res.data.status === 'success') {
          _this2.adminTable.innerHTML = "\n                    <thread>\n                      <tr>\n                        <td width=\"100\">\uD559\uAD50</td>\n                        <td width=\"400\">\uC81C\uBAA9</td>\n                        <td width=\"100\">\uD6C4\uBCF4\uC790</td>\n                        <td width=\"200\">\uD22C\uD45C\uC218</td>\n                        <td width=\"100\">\uD22C\uD45C\uC911</td>\n                        <td width=\"100\">1\uB4F1</td>\n                     </tr>\n                    </thread>\n                    ";
          res.data.pledges.forEach(function (pledge) {
            var resultElement = document.createElement('tr');
            resultElement.innerHTML = "\n                        <td width=\"100\" text-align=\"center\">\n                            ".concat(pledge.school, "\n                        </td>\n                        <td width=\"400\" text-align=\"center\">\n                            ").concat(pledge.title, "\n                        </td>\n                        <td width=\"100\" text-align=\"center\">\n                            ").concat(pledge.candidate.name, "\n                        </td>\n                        <td width=\"200\" text-align=\"center\">\n                            ").concat(pledge.voteCount, "\n                        </td>\n                        <td width=\"100\" text-align=\"center\">\n                            ").concat(pledge.canVote, "\n                        </td>\n                        ");

            if (res.data.winner.includes(pledge.candidateId) && pledge.candidate.role !== 'president' && pledge.voteCount !== 0) {
            ...
            _this2.adminTable.append(resultElement);
          });
          document.querySelectorAll('.electBtn').forEach(function (btn, i) {
            btn.addEventListener('click', function (e) {
              e.preventDefault();

              if (canVote === 'false') {
                _axios.default.post("".concat(_main.backend, "/api/pledge/admin"), {
    ...
    key: "voteReset",
    value: function voteReset() {
      var result = confirm('초기화?');

      if (result) {
        _axios.default.patch("".concat(_main.backend, "/api/pledge/admin"), {}, {
          headers: {
            authorization: "Bearer ".concat(token)
          }
        }).then(function (res) {
...
var _register = _interopRequireDefault(require("./register1"));

var _register2 = _interopRequireDefault(require("./register2"));

var _userAuth = _interopRequireDefault(require("./userAuth"));

var _createPost = _interopRequireDefault(require("./createPost"));

var _loadPosts = _interopRequireDefault(require("./loadPosts"));

var _viewPost = _interopRequireDefault(require("./viewPost"));

var _viewApply = _interopRequireDefault(require("./viewApply"));

var _viewPledge = _interopRequireDefault(require("./viewPledge"));
...
var backend = 'https://dcrasee.tk'; // export const backend = 'http://localhost:4000';
